...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="window" style={{ height: "600px", width: "300px", backgroundColor: 'silver', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} ref={windowRef}>

        {/* <div className="window" style={{ height: "600px", width: "300px" }} ref={windowRef}> */}
          ...
          <div className="window-body">
            <div className="aol-box" style={{ height: '100%', width: '100%', backgroundColor: '#005BAB', opacity: 1 }}>
              <img src='/login-header.png' alt="" style={{ margin: '0 auto' }}/>
            </div>
            <div className="field-row-stacked" style={{ width: "200px", justifyContent: 'center' }}>
